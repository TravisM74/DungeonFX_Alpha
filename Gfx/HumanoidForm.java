...
public class HumanoidForm extends Group {
	...
	public HumanoidForm(Color hair,Color skin,Color eye,Color top,Color pants, Color shoe) {
		this.hairColor = hair;
		this.skinColor = skin;
		this.eyeColor = eye;
		this.topColor = top;
	...
	public void setHairColor(Color hair) {
		this.hairColor = hair;
	}
	public void setSkinColor(Color skin) {
		this.skinColor =skin;
	}
	public void setEyeColor(Color eye) {
		this.eyeColor = eye;
	}
	public void setTopColor(Color top) {
		this.topColor = top;
	}
	public void setPantsColor(Color pants) {
		this.pantsColor = pants;
		
	}
	public void setShoeColor(Color shoes) {
